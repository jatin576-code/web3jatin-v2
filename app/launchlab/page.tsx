      ...
      <section id="about" className="py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-body-text leading-relaxed">
            Jatin Launch Lab is a 4-week program where I partner with <span className="font-bold text-secondary">one pre-TGE Web3 project</span> helping them with the strategy and execution of their token launch and prepare them for TGE.
          </p>
